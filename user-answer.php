...
<head>
    <title>Отправить ответы | Личный кабинет | &laquo;Школьное движение&raquo; - всероссийский
        конкурс</title>
    <meta charset="utf-8">
    ...
    <script type="text/javascript">
                ...
                success: function (d) {
                    if (d.error) {
                        ...
                        if (d.files.length == 0) {
                            ...
                            var s = "<table><tr><td><b>Дата</b></td><td><b>Название</b></td></tr>";
        ...
        function UpdateChoosenFiles(input) {
            ...
            var s = "<table><tr><td><b>Выбранные файлы</b></td></tr>";
        ...
        function ContinueLoading() {
            if (files.length > 0) {
                if (messageWindow == null) {
                    messageWindow = Message.create({
                        header: 'Пожалуйста, подождите',
                        text: 'Загрузка файла ' + files[0].name,
                        closeable: false
                    });
                }
    ...
    <div class="limit-block">
        <div class="flex-block flex-column flex-top flex-left">
            ...
            <div>
                ...
                <div class="<?php if ( constants::PAYMENT_FOR_ANSWERS and (!isset( $_SESSION[ 'usertype' ] ) or
                ...
                <?php
                if ( constants::PAYMENT_FOR_ANSWERS and (!isset( $_SESSION[ 'usertype' ] ) or $_SESSION[ 'usertype' ] != 1 )) {
