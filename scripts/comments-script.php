<?php
    ...
    if (!isset($_SESSION['usertype']) or !isset($_SESSION['userkey']) or $_SESSION['usertype'] != 1){
    ...
    $sql = mysqli_query($link, "REPLACE INTO `comments`(`userkey`,`name`,`text`) VALUES ('$userkey','$name','$text')");
