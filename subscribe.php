...
<head>
    <title>Подписка | &laquo;Школьное движение&raquo; - всероссийский конкурс</title>
    <meta charset="utf-8">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            document.getElementById("subscribe-form").addEventListener("submit", function(e) {
                ...
                $.ajax({
                    ...
                    success: function(d) {
                        if (d.error) {
                            Message.create({header: "Ошибка", text: "При попытке оформить подписку произошла ошибка. Попробуйте позже"});
                        } else {
            ...
            document.getElementById("unsubscribe-form").addEventListener("submit", function(e) {
                ...
                $.ajax({
                    ...
                    success: function(d) {
                        if (d.error) {
                            Message.create({header: "Ошибка", text: "При попытке отписки произошла ошибка"});
                        } else {
                            Message.create({header: "Успех", text: 'Вы успешно отписались от рассылки'});
                        }
                    },
                    error: function(d) {
                        alert(d);
                ...
                <div class="flex-block flex-row flex-top flex-left">
                    ...
                    ?>
                        <div>
                            ...
                            <h2>Здесь Вы можете оформить подписку на наши новости или отписаться от новостей</h2>
                            <form action="subscribe-script.php" method="get" id="subscribe-form" class="card">
                                ...
                                <div>
                                    <input type="email" name="email" class="text-input email" style="width: 300px;">
                                </div>
                                <div>
                            ...
                            <form action="subscribe-script.php" method="get" id="unsubscribe-form" class="red-card">
